...
export default async function (req: Request): Promise<Response> {
  ...
  if (req.method !== "GET") {
    return new Response(
      JSON.stringify({ data: null, error: { code: "METHOD_NOT_ALLOWED", message: "Use GET" } }),
  ...
  return new Response(
    JSON.stringify({ data: null, error: { code: "NOT_IMPLEMENTED", message: "GET /persona-boost/status not yet implemented" } }),
