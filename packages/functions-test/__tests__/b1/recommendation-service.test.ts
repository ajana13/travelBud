...
describe("recommendation-service", () => {
  ...
  describe("applyDiversity()", () => {
    it("limits items per pillar", () => {
      const scored = [
        { item: makeItem({ id: "e1", pillar: "events" }) as any, score: 0.9, tagOverlap: [] },
        { item: makeItem({ id: "e2", pillar: "events" }) as any, score: 0.8, tagOverlap: [] },
        { item: makeItem({ id: "e3", pillar: "events" }) as any, score: 0.7, tagOverlap: [] },
        { item: makeItem({ id: "d1", pillar: "dining" }) as any, score: 0.6, tagOverlap: [] },
      ];
